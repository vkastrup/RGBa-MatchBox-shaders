// Matchbox Floyd-Steinberg Dithering Shader for Autodesk Flame
// Author: GitHub Copilot
// Date: 2025-11-14
// Description: Floyd-Steinberg dithering with adjustable quantization levels
...
void main()
{
    ...
    // Adjust threshold range (-0.5 to 0.5) and apply spread
